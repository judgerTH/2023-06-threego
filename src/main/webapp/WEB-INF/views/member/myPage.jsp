				...
				<div class="left-div">
					...
					<ul>
						...
						<li><a class="" aria-current="page"
							href="<%= request.getContextPath() %>/member/requestList?memberId=<%= memberId %>">결제정보</a></li>
						<li><a class="" aria-current="page"
							href="<%= request.getContextPath() %>/member/notebox">📑받은
								메시지</a></li>
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" id="phone" name="mb_tel"
										value="<%= phone %>" required maxlength="20"
										placeholder="전화번호">
								...
								<tr>
									...
									<td><label for="reg_mb_zip" class="sound_only">우편번호
										...
										<button type="button" id="postal-search" class="btn_frmline"
											onclick="addressSearch()">주소 검색</button>
										<br>
									<br> <input type="text" id="userAddress" name="mb_addr1"
									...
									<br> <input type="text" name="mb_addr2" value="<% %>"
										size="50" placeholder="상세주소"> <label
										for="reg_mb_addr2" id="userDetailAddress" class="sound_only">상세주소</label><br>
									<br></td>
								</tr>
							</tbody>
						</table>
