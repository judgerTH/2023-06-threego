...
제 1조(목적)
이 약관은 쓰리고(이하 “회사“라 합니다)이 제공하는 쓰리고 서비스와 관련하여, 회사와 이용 고객간에 서비스의 이용조건 및 절차, 회사와 회원 간의 권리,의무 및 기타 필요한 사항을 규정함을 목적으로 합니다.

제 2조(용어의 정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.

1. “쓰리고“라 함은 “회사“가 재화 또는 “생활폐기물“ 분리수거 대행 서비스를 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 서비스 등을 거래할 수 있도록 설정한 가상의 영업장을 말합니다.
2. “회원“이라 함은 “플랫폼“에 개인정보를 제공하여 “회원“등록을 한 자로서, “서비스“의 정보를 지속적으로 제공받으며, “쓰리고“가 제공하는 서비스를 계속적으로 이용할 수 있는 자를 의미합니다.
...
2. ”회원”이 다음 각 호의 사유에 해당하는 경우, ”회사”는 회원자격을 제한, 정지 및 ”서비스” 이용을 중지시킬 수 있습니다.
 ...
 다. “회사”나 “쓰리고” 직원에게 폭행 또는 상해를 입히거나 기타 법령에 위반되는 피해를 입힌 경우
...
1. ”회사”는 다음과 같은 서비스를 제공합니다.
 가. “생활폐기물“ 분리수거 대행 서비스: “회원“은 “생활 폐기물“을 지정된 날짜 또는 요일에 지정된 장소에 배출하면 “쓰리고 직원“이 해당 “생활 폐기물“을 회원의 아파트 지정 분리수거장에 분리배출을 대행합니다.
  1)가끔수고: 월 2회 (2주 1회)
  2)자주수고: 월 4회 (1주 1회)
...
1. “쓰리고“의 이용은 “회사“의 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간 제공을 원칙으로 합니다. 다만, “생활폐기물“ 분리수거 대행 서비스의 경우에는 주 5일 9시부터 18시 제공을 원칙으로 합니다.(토요일, 일요일 및 국가공휴일, 대체휴일은 휴일) 
...
1. “회원“은 “쓰리고“에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “회사“는 “회원“이 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.
 가. “쓰리고“에서 제공하는 서비스 패키지 요금제 선택
...
1. “쓰리고“는 이용자의 서비스신청이 있는 경우 이용자에게 수신확인통지를 합니다.

2. 수신확인통지를 받은 이용자는 의사표시의 불일치 등이 있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고, “쓰리고“는 서비스 전에 이용자의 요청이 있는 경우에는 지체 없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제20조의 환불 등에 관한 규정에 따릅니다.
...
제 17조(지급방법)
1. “쓰리고“에서 가입한 요금제 등에 대한 대금지급방법은 다음 각 호의 방법 중 가용한 방법으로 할 수 있습니다. 단, “회사“는 “회원“의 지급방법에 대하여 상품 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.
...
3. “회원“이 부정한 방법으로 할인쿠폰을 획득한 사실이 확인될 경우 “회사“는 “회원“의 무료쿠폰을 회수, “쓰리고“계정 삭제, “서비스“이용 중지 및 형사고발 등 기타 조치를 취할 수 있습니다.
...
- 시행일자: 2022년 6월 30일</textarea>
					...
					<div id="nextForm">
						...
						<br><br><br><br>
							<table id="enroll" style= "width : 80%; margin : 0 auto;">
								<tr>
						...
						<form id="completeTag" style="display: none;">
						<div>  회원가입 성공했습니다. 우측 상단의 로그인 버튼을 클릭해 이용해주십시오.</div></form>
